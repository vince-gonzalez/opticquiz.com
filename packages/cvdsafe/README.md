...
[![npm version](https://img.shields.io/npm/v/cvdsafe)](https://www.npmjs.com/package/cvdsafe)
...
`cvdsafe` is a front door to the [`opticquiz-cvd`](https://www.npmjs.com/package/opticquiz-cvd)
