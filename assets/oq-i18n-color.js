...
(function (D) {
  var S = {
    en: {
      ...
      "faq.4.a": "Yes — free, no account, and the test runs entirely on your device. Your answers and scores are never uploaded or stored.",
    ...
    es: {
      ...
      "faq.4.a": "Sí: gratuito, sin cuenta, y la prueba se ejecuta enteramente en tu dispositivo. Tus respuestas y puntuaciones nunca se suben ni se almacenan.",
    ...
    fr: {
      ...
      "faq.4.a": "Oui — gratuit, sans compte, et le test s'exécute entièrement sur votre appareil. Vos réponses et vos scores ne sont jamais envoyés ni conservés.",
    ...
    de: {
      ...
      "faq.4.a": "Ja — kostenlos, ohne Konto, und der Test läuft vollständig auf Ihrem Gerät. Ihre Antworten und Ergebnisse werden nie hochgeladen oder gespeichert.",
    ...
    pt: {
      ...
      "faq.4.a": "Sim — gratuito, sem conta, e o teste corre inteiramente no seu dispositivo. As suas respostas e pontuações nunca são enviadas nem guardadas.",
    ...
    it: {
      ...
      "faq.4.a": "Sì — gratuito, senza account, e il test viene eseguito interamente sul tuo dispositivo. Le tue risposte e i tuoi punteggi non vengono mai caricati né conservati.",
    ...
    zh: {
      ...
      "faq.4.a": "免费——无需账号，测试完全在你的设备上运行。你的作答和分数不会被上传或存储。",
      "faq.4.q": "这个测试免费吗？",
      "faq.h2": "常见问题",
    ...
    hi: {
      ...
      "faq.4.a": "हाँ — निःशुल्क, बिना खाते के, और परीक्षण पूरी तरह आपके डिवाइस पर चलता है। आपके उत्तर और अंक कभी अपलोड या संग्रहित नहीं किए जाते।",
